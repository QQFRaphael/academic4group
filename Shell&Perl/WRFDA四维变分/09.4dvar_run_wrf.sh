#!/bin/sh
##PBS -l nodes=n10:ppn=16+n11:ppn=16+n12:ppn=16+n13:ppn=16+n14:ppn=16+n15:ppn=16+n16:ppn=16
...
ln -sf ${VAR_OUT}/wrfvar_output_d01_06 ./wrfinput_d01
ln -sf ${VAR_OUT}/wrfvar_output_d02_06 ./wrfinput_d02
ln -sf ${VAR_OUT}/wrfinput_d03_06 ./wrfinput_d03

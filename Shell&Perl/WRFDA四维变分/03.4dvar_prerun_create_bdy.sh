...
sed -i "15s/^.*.$/ end_hour                            = 06,   06,   06,/" ./namelist.input
cp ./wrfinput_d02 ./wrfndi_d02
ln -sf ${VAR_OUT}/wrfout_d01_2014-05-22_0[0-6]:00:00 .
mpirun -np 30 ./ndown.exe
rm -rf wrfout*

mv wrfbdy_d01 wrfbdy_d01_00
mv wrfbdy_d01_00 ${VAR_OUT}
cp ${VAR_OUT}/wrfbdy_d01_00 ${VAR_OUT}/wrfbdy_d01_00.bak

mv wrfinput_d01 wrfinput_d01_00
mv wrfinput_d01_00 ${VAR_OUT}
cp ${VAR_OUT}/wrfinput_d01_00 ${VAR_OUT}/wrfinput_d01_00.bak

mv wrfbdy_d02 wrfbdy_d02_00
mv wrfbdy_d02_00 ${VAR_OUT}
cp ${VAR_OUT}/wrfbdy_d02_00 ${VAR_OUT}/wrfbdy_d02_00.bak

mv wrfinput_d02 wrfinput_d02_00
mv wrfinput_d02_00 ${VAR_OUT}
cp ${VAR_OUT}/wrfinput_d02_00 ${VAR_OUT}/wrfinput_d02_00.bak

mv wrfinput_d03 wrfinput_d03_00
mv wrfinput_d03_00 ${VAR_OUT}
cp ${VAR_OUT}/wrfinput_d03_00 ${VAR_OUT}/wrfinput_d03_00.bak
